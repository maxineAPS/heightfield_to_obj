...
def generate_tile(heightmap_path, output_path, tile_size=100, base_thickness=3, z_add=0, target_size=5.0, full_field = True):
    # here is where 
...
if __name__ == "__main__":
    ...
    output_path = "output8.obj" #output obj path
    z_add = 0  # manually tuned to match examples, variable that controls height of block
    generate_tile(heightmap_path, output_path, z_add=z_add, target_size=5.0, full_field=False) #target size is target width/height of block
